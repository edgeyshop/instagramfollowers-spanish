...
const InstagramReelViews = () => {
    ...
    const instagramReelViewsOptions = [
        { amount: 1000, price: '1.99', label: '1,000 Reels Views' },
        { amount: 2000, price: '3.49', label: '2,000 Reels Views' },
        { amount: 5000, price: '7.99', label: '5,000 Reels Views' },
        { amount: 10000, price: '14.49', label: '10,000 Reels Views' },
        { amount: 20000, price: '27.99', label: '20,000 Reels Views' },
    ];
    ...
    const price = useMemo(() => {
        return instagramReelViewsOptions.find(item => item.amount == amount)?.price;
    }, [amount]);
                        ...
                        <div className="col-12 col-lg-6 offset-lg-1">
                            <div className="breadcrumb text-small p-0">
                                <ul>
                                    ...
                                    <li>Instagram Reel Views</li>
                                </ul>
                            </div>
                            <div className="d-flex align-items-center">
                                <div className="flex-grow-1">
                                    <div className="text-extra-dark-gray font-weight-500 text-extra-large alt-font margin-5px-bottom">Buy Instagram Reel Views</div>
                            ...
                            <div className="last-paragraph-no-margin">
                                <p>
                                    Buying Instagram Reel Views will make you instantly receive the views you want as soon as you post to your profile. Automate your Instagram account quickly and 100% securely.
                                </p>
                                <br />
                                Amount
                                <select value={amount} onChange={e => setAmount(e.target.value)}>
                                    {instagramReelViewsOptions.map((item, index) => (
...
export default InstagramReelViews;